...
public class OrdersLoader implements Runnable {
  ...
  public OrdersLoader(String fileName, String connectString, String username, String password) {
  ...
  public void run() {
    try {
      ...
      PreparedStatement stmt = con.prepareStatement("INSERT INTO orders(o_orderkey, o_custkey, o_orderstatus, o_totalprice, o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment) VALUES (?,?,?,?,?,?,?,?,?)");
      ...
      while ((line = reader.readLine()) != null) {
        ...
        stmt.setDate(5, Date.valueOf(parts[4].trim()));
        stmt.setString(6, parts[5].trim());
        stmt.setString(7, parts[6].trim());
        stmt.setInt(8, Integer.parseInt(parts[7].trim()));
