...
public abstract class BenchmarkModule {
    ...
    public String getDatabaseDDLPath(DatabaseType db_type) {
        ...
        if (db_type != null) {
            ...
            if (ddl_db_type == DatabaseType.AURORA_MYSQL) ddl_db_type = DatabaseType.MYSQL;
            if (ddl_db_type == DatabaseType.AURORA_POSTGRES) ddl_db_type = DatabaseType.POSTGRES;
            if (ddl_db_type == DatabaseType.TIDB) ddl_db_type = DatabaseType.MYSQL;
